...
library LibDiamond {
    ...
    bytes32 constant AutoFarmV2_STORAGE_POSITION =
        keccak256("diamond.standard.AutoFarmV2.storage");
    ...
    function autoFarmV2Storage()
        internal
        pure
        returns (AutoFarmV2Storage storage a)
    {
        bytes32 position = AutoFarmV2_STORAGE_POSITION;
        assembly {
            a.slot := position
        }
    }
