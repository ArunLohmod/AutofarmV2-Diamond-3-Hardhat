...
contract DiamondInit {
    ...
    function stratX2Init(
        ...
        s.govAddress = _autoFarmAdress;
        s.autoFarmAddress = _autoFarmAdress;
        s.farmContractAddress = _farmContractAddress;
        s.isAutoComp = _isAutoComp;
        s.pid = 0;
        s.AUTOAddress = tokenAddresses[0];
        s.wantAddress = tokenAddresses[1];
        s.earnedAddress = tokenAddresses[2];
        s.token0Address = tokenAddresses[3];
        s.token1Address = tokenAddresses[4];
        s.uniRouterAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
